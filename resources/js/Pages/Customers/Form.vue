            ...
            <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">بيانات العميل الرئيسية</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 p-6">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    :value="customer?.code || 'سيتم توليده تلقائياً'"
                                    type="text"
                    ...
                    <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">ملاحظات وحالة العميل</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                    ...
                    >
                        ...
                        <span>{{ form.processing ? 'جاري الحفظ...' : (customer ? 'تحديث العميل' : 'إضافة العميل') }}</span>
                    </button>
                </div>
            </form>
        </div>
